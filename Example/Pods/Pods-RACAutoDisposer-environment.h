...
// RACAutoDisposer
#define COCOAPODS_POD_AVAILABLE_RACAutoDisposer
#define COCOAPODS_VERSION_MAJOR_RACAutoDisposer 0
#define COCOAPODS_VERSION_MINOR_RACAutoDisposer 1
#define COCOAPODS_VERSION_PATCH_RACAutoDisposer 0
